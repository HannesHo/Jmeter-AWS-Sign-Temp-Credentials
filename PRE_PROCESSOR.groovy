...
def amzToken = vars.get("aws_token")
...
def signed_headers = "host;x-amz-date;x-amz-security-token"
...
static String orderQuery(URL url) throws UnsupportedEncodingException {
